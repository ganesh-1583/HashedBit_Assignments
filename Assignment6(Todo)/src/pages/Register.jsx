...
export default function Register() {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            console.error(e);
            alert("Error While Registering User : " + e);
        }
    }
            ...
            <div className="h-[100%] w-screen flex justify-center items-center bg-[#f0f4f8]">
                <div className="rounded-4xl w-[40%] h-[50%] bg-[#ffffff] 0px 4px 20px rgba(0,0,0,0.1) p-6">
                    <form onSubmit={handleRegister}>
                        ...
                        <br />
                        <div className="flex justify-center p-5 mt-16 bg-[#3f51b5] rounded-4xl w-[50%] m-[25%] text-[#fff] hover:scale-[105%] transition duration-400">
